...
namespace ExpediaTest
{
    ...
    public class HotelTest
    {
        ...
        public void TestThatHotelDoesGetRoomOccupantFromTheDatabase()
        {
            ...
            String annotherRoomOccupant = "Raptor Wrangler";
            using (mocks.Ordered())
            {
                Expect.Call(mockDB.getRoomOccupant(24)).Return(roomOccupant);
                Expect.Call(mockDB.getRoomOccupant(1025)).Return(annotherRoomOccupant);
            ...
            Assert.AreEqual(annotherRoomOccupant, result);
